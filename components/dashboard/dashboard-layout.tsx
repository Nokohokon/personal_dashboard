...
export default function DashboardLayout({ children }: DashboardLayoutProps) {
  ...
  return (
    <div className="h-screen flex bg-slate-900">
      ...
      {/* Sidebar */}
      <div
        className={`fixed inset-y-0 left-0 z-30 w-64 transform bg-slate-800 shadow-xl transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:inset-0 ${
      ...
      {/* Main content */}
      <div className="flex flex-1 flex-col overflow-hidden">        {/* Top bar */}
